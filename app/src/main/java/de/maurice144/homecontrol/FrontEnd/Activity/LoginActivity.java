...
public class LoginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
                if (id == 115 || id == EditorInfo.IME_NULL) {
                    attemptLogin();
                    return true;
                }
                return false;
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            WebApi api  = new WebApi(LoginActivity.this,settings);
            ...
            try {
                ...
                Log.e("WebLogin", ex.getMessage(), ex);
                cancel(true);
                return false;
            }
            return loginOk;
        ...
        protected void onCancelled() {
            ...
            LoginActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    Toast.makeText(LoginActivity.this, "Login nicht verfügbar. Versuchen Sie es später noch einmal.", Toast.LENGTH_LONG).show();
                }
            });
        }
    }
